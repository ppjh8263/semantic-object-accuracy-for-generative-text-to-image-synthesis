...
class parse_args():
    def __init__(self):
        self.cfg_file = '/home/piai/semantic-object-accuracy-for-generative-text-to-image-synthesis/OP-GAN/code/cfg/cfg_file_train.yml'
        self.gpu_id = '0,1'
        self.resume = ''
        self.data_dir = '/home/piai/semantic-object-accuracy-for-generative-text-to-image-synthesis/OP-GAN/data'
        self.net_g = ''
        self.max_objects = 10
...
if __name__ == "__main__":
    ...
    if cfg.TRAIN.FLAG:
        if not resume:
            copyfile("/home/piai/semantic-object-accuracy-for-generative-text-to-image-synthesis/OP-GAN/code/main.py", output_dir + "/" + "main.py")
            copyfile("/home/piai/semantic-object-accuracy-for-generative-text-to-image-synthesis/OP-GAN/code/trainer.py", output_dir + "/" + "trainer.py")
            copyfile("/home/piai/semantic-object-accuracy-for-generative-text-to-image-synthesis/OP-GAN/code/model.py", output_dir + "/" + "model.py")
            copyfile("/home/piai/semantic-object-accuracy-for-generative-text-to-image-synthesis/OP-GAN/code/miscc/utils.py", output_dir + "/" + "utils.py")
            copyfile("/home/piai/semantic-object-accuracy-for-generative-text-to-image-synthesis/OP-GAN/code/miscc/losses.py", output_dir + "/" + "losses.py")
            copyfile("/home/piai/semantic-object-accuracy-for-generative-text-to-image-synthesis/OP-GAN/code/GlobalAttention.py", output_dir + "/" + "GlobalAttention.py")
            copyfile("/home/piai/semantic-object-accuracy-for-generative-text-to-image-synthesis/OP-GAN/code/datasets.py", output_dir + "/" + "datasets.py")
